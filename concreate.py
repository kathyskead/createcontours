...
##    os.mkdir('{0}/dem_tiles_buff'.format(os.path.split(workspace)[0]))
    ...
    contour_dict = {i:k for i,k in itertools.izip(sorted(get_final_tiles()),contour_smooth)}
    clip_tiles_dict = get_final_tiles()
